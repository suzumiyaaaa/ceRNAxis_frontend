...
const timelineItems = [
    ...
    }, */
    {
        ...
        children:
            (
                <>
                    <Title level={4} style={{ marginBottom: 8 }}>Version 1.0 (2026-x-xx): Initial Release: Welcome to
                        ceRNAxis!</Title>
                    <Box>
                        ceRNAxis launches with ceRNA data from GDC Portal&apos;s <strong>52</strong> projects.
                        <ul style={{ paddingLeft: '20px', margin: 0 }}>
                            <li>
...
const News = () => {
    return (
        <Card
            title={<Title level={3}>ceRNAxis Release Notes</Title>}
            style={{
                borderRadius: '8px',
